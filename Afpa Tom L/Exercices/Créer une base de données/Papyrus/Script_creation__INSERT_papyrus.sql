...
(120, 'GROSBRIGAND', '20 rue du papier', '92200', 'papercity', 'Georges', 8),
...
('B001', 'Bande magnétique 1200', 20, 13, 240, 'unite'),
('B002', 'Bande magnétique 6250', 20, 123, 410, 'unite'),
...
--
DELIMITER $$
CREATE TRIGGER `trigger1` AFTER UPDATE ON `produit` FOR EACH ROW BEGIN
